...
bincode_serialization_config = sb.SerializationConfig(
...
def serialize(obj: typing.Any, obj_type) -> bytes:
    return sb.serialize_with_config(bincode_serialization_config, obj, obj_type)


def deserialize(content: bytes, obj_type) -> typing.Tuple[typing.Any, bytes]:
    return sb.deserialize_with_config(bincode_deserialization_config, content, obj_type)
